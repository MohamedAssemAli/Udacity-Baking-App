package udacity.assem.com.udaceity_baking_app.App;
...
public class AppConfig {
    ...
    public static final String SAVED_INSTANCE_CURRENT_WINDOW = "currentWindow";
    public static final String SAVED_INSTANCE_PLAY_WHEN_READY = "playWhenReady";
